...
- [`tab_get_vars()`](https://bricenocenti.github.io/tabxplor/reference/tab_many.md)
  ...
  tab_plot)
- [`get_color_style()`](https://bricenocenti.github.io/tabxplor/reference/tab_many.md)/[`set_color_breaks()`](https://bricenocenti.github.io/tabxplor/reference/tab_many.md)
...
| vctrs record contract | Adding a field to `tabxplor_fmt` requires updating [`new_fmt()`](https://bricenocenti.github.io/tabxplor/reference/new_fmt.md), [`fmt()`](https://bricenocenti.github.io/tabxplor/reference/fmt.md), [`format.tabxplor_fmt()`](https://bricenocenti.github.io/tabxplor/reference/format.tabxplor_fmt.md), [`pillar_shaft.tabxplor_fmt()`](https://bricenocenti.github.io/tabxplor/reference/pillar_shaft.tabxplor_fmt.md), `vec_arith` methods, and possibly [`tab_pct()`](https://bricenocenti.github.io/tabxplor/reference/tab_pct.md)/[`tab_ci()`](https://bricenocenti.github.io/tabxplor/reference/tab_ci.md)/[`tab_chi2()`](https://bricenocenti.github.io/tabxplor/reference/tab_chi2.md). ~8 functions across 3 files. |
...
| data.table internals | [`tab_plain()`](https://bricenocenti.github.io/tabxplor/reference/tab_plain.md)/[`tab_num()`](https://bricenocenti.github.io/tabxplor/reference/tab_num.md) rename `col_var` to internal names to avoid data.table conflicts. The user’s column names are restored afterward. |
...
- **`tabxplor_fmt`**: vctrs record (`new_rcrd()`) with **19 per-cell
  ...
  [`new_fmt()`](https://bricenocenti.github.io/tabxplor/reference/new_fmt.md)
  (internal, calls
...
- **`tabxplor_tab`**: tibble subclass via
  ...
  **`meta`** — ONE named list holding `render_extras` (Phase 10i-B, the
  ...
  [`set_caption()`](https://bricenocenti.github.io/tabxplor/reference/set_caption.md)/[`get_caption()`](https://bricenocenti.github.io/tabxplor/reference/set_caption.md)
...
- **[`format.tabxplor_fmt()`](https://bricenocenti.github.io/tabxplor/reference/format.tabxplor_fmt.md)**
...
[`tabxplor::jmvtab()`](https://bricenocenti.github.io/tabxplor/reference/jmvtab.md)
...
| `.by_table` on [`tab_many()`](https://bricenocenti.github.io/tabxplor/reference/tab_many.md) | **Make internal now** (parity-test plumbing, not a public arg) |
| `conditional_format`, `n_min`, `hide_near_zero` on [`tab_xl()`](https://bricenocenti.github.io/tabxplor/reference/tab_xl.md) | **Drop now**, before release |
| `filter=` string arg on [`tab()`](https://bricenocenti.github.io/tabxplor/reference/tab.md) | **Doc-deprecate** (keep working) |
...
5.  [`tab_plain()`](https://bricenocenti.github.io/tabxplor/reference/tab_plain.md)
...
[`format.tabxplor_fmt()`](https://bricenocenti.github.io/tabxplor/reference/format.tabxplor_fmt.md)’s
...
1.  **Leaf wrapper/core split** (decisions §29 Finding 3, endorsed):
    public
    [`tab_plain()`](https://bricenocenti.github.io/tabxplor/reference/tab_plain.md)/[`tab_num()`](https://bricenocenti.github.io/tabxplor/reference/tab_num.md)
...
[`tab_pct()`](https://bricenocenti.github.io/tabxplor/reference/tab_pct.md)/[`tab_tot()`](https://bricenocenti.github.io/tabxplor/reference/tab_tot.md)/[`tab_totaltab()`](https://bricenocenti.github.io/tabxplor/reference/tab_totaltab.md) +
...
[`cleannames_condition()`](https://bricenocenti.github.io/tabxplor/reference/cleannames_condition.md)
...
2.  **Programming vignette (`tabxplor-programming.Rmd`)**:
    ...
    - [`score_from_lv1()`](https://bricenocenti.github.io/tabxplor/reference/score_from_lv1.md)
      ...
      worked example.
    - A pointer paragraph:
      [`tab_many()`](https://bricenocenti.github.io/tabxplor/reference/tab_many.md)’s
      list mode +
...
[`tab_logit()`](https://bricenocenti.github.io/tabxplor/reference/tab_logit.md)/[`multi_logit()`](https://bricenocenti.github.io/tabxplor/reference/multi_logit.md)
...
while keeping the
alias[`tab_kable()`](https://bricenocenti.github.io/tabxplor/reference/tab_html.md)
...
auto-[`tab_spread()`](https://bricenocenti.github.io/tabxplor/reference/tab_spread.md)s
...
[`tab()`](https://bricenocenti.github.io/tabxplor/reference/tab.md) too
(current default is pvalue line only).
...
[`tab()`](https://bricenocenti.github.io/tabxplor/reference/tab.md)/`tab_num`/`tab_counts`/`tab_reg`. -
...
[`tab()`](https://bricenocenti.github.io/tabxplor/reference/tab.md)/[`tab_reg()`](https://bricenocenti.github.io/tabxplor/reference/tab_reg.md)
...
[`?tab`](https://bricenocenti.github.io/tabxplor/reference/tab.md) near
the weighting paragraph. - With an overdispersed count outcome (Pearson
dispersion 2.04), a `family = "poisson"` fit returns CIs/p-values
**identical to `family = "quasipoisson"`** (SEs scaled by
...
- **Root cause**:
  [`pillar_shaft.tabxplor_fmt()`](https://bricenocenti.github.io/tabxplor/reference/pillar_shaft.tabxplor_fmt.md)
...
- **Expected**: an informative “`col_var` must be a factor, character or
  ...
  [`tab()`](https://bricenocenti.github.io/tabxplor/reference/tab.md) is
...
[`tab()`](https://bricenocenti.github.io/tabxplor/reference/tab.md)/[`tab_num()`](https://bricenocenti.github.io/tabxplor/reference/tab_num.md),
and
...
[`?tab`](https://bricenocenti.github.io/tabxplor/reference/tab.md) (test
para + Weighted-CIs details),
[`?tab_reg`](https://bricenocenti.github.io/tabxplor/reference/tab_reg.md)
...
**DONE (2026-07-23).** Full suite green (FAIL 0, WARN 0, SKIP 4, PASS
4261), zero golden/snapshot churn. - **README single-source rewrite**:
concise `README.Rmd` (`github_document`, `html_preview: false`) knit to
`README.md` with 3 LIVE colored html tables (the vignette machinery:
`tabxplor.print="html"` + one `tab_css(theme="light")` asis chunk +
`tab_kable_css=FALSE`) — the pkgdown home renders them colored, GitHub
strips `<style>`/classes to plain-but-readable tables. One hero
screenshot at `man/figures/README-hero.jpg` (CRAN-safe path; **stopgap =
the 1.3.1 console JPG, maintainer should recapture with the 2.0.0
palette**). Vignette links = absolute pkgdown URLs, intro first + FR
articles. The old `.readme_images/` refs (broken on pkgdown/CRAN) are
gone from the README; the folder awaits maintainer deletion. -
**`options(tabxplor.totcol_range)` retired → DORMANT** (deliberate
exception to “no commented corpses”, tagged
`# DORMANT (possible future implementation)`): seed commented in
`.onLoad`, read branch commented in `tab_fold_addn_incell` (tab.R),
`range_totcol` compute commented in the prep (named NULL slot stays in
the model), the 3 `"range"` compute-flag seeds dropped;
`tab_totcol_range()` helper KEPT, exercised directly by
test-export-prep.R. Option doc + both programming-vignette bullets
removed. Rationale: its per-row literal templates defeat the
composite-token padding (format aligns per unique template) and no
renderer ever consumed `range_totcol`. Dead-option audit: totcol_range
was the ONLY defective option; all other seeded options are live and
doc-synced. - **jamovi html tooltips ON by default**: the two hard-coded
`tooltips = FALSE` (jmvtab-export.R `tab_html_string` +
`jmv_backend_render_html`) deleted → both follow
`tabxplor.tab_kable_tooltips` (seeded TRUE); native `title=` attrs need
no bootstrap JS in the webview. Perf trade (~+15% render, +44% DOM)
accepted. Fixtures in test-jmvtab-export.R. **Maintainer: live-jamovi
smoke test on a big table recommended.** - **Follow-up (same day):
pkgdown colors + Articles menu.** (1) Cell colors were washed out on the
whole pkgdown site: pkgdown stamps `class="table"` on every table, and
Bootstrap 5’s `.table>:not(caption)>*>*` (0,1,1) sets color/background
on the SAME `<td>` a bare `.p1` (0,1,0) targets — so every cell rule
lost (legend spans survived: direct-beats-inherited). Fix in
[`tab_css()`](https://bricenocenti.github.io/tabxplor/reference/tab_css.md)
(`tx_cell_sel`, tab-css.R): every cell colour class
(`.p1-.p4/.m1-.m4/.o*/.u*/.g1/.g2`) is emitted bare AND scoped
`.tabxplor-tab .p1` (0,2,0) — beats Bootstrap-flavoured hosts
(incl. Quarto) with no `!important`; conscious golden.md regen (CSS
lines only); the chrome-free md contract test now asserts
absence-of-chrome, not absence of the class name. (2) The intro vignette
was missing from the site’s Articles menu (pkgdown special-cases the
package-named vignette as “Get started” and drops it from the
auto-menu): `_pkgdown.yml` now defines the navbar `articles` component
EXPLICITLY (EN + FR entries). (3) TEMPORARY
`vignettes/articles/test-colors.Rmd` (+ its `_pkgdown.yml` index entry)
= a visual checklist page for the maintainer — **delete both once colors
are verified on the live site**. (4) The html STARS LEGEND lost its
`***`/`**`/`*` glyphs on every knitted page: pandoc (Rmd → md → html)
parses markdown INSIDE raw-html blocks and paired the runs as emphasis
(in-cell stars survived as unmatched runs pandoc re-escapes;
Viewer/jamovi never re-parse). Fix: `legend_render_line`’s esc-flagged
token is entity-encoded `&#42;` on the html medium (fmt_class.R, one
line beside the md backslash-escape); fixture in test-render-html.R.
