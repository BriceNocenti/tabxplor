# CSS for the colour spans of [`tab_md`](https://bricenocenti.github.io/tabxplor/fr/reference/tab_md.md)

A thin wrapper around
[`tab_css(chrome = FALSE)`](https://bricenocenti.github.io/tabxplor/fr/reference/tab_css.md),
