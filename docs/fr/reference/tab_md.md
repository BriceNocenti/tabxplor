...
- special_formatting:
  ...
  Passed to
  [`format()`](https://bricenocenti.github.io/tabxplor/fr/reference/format.tabxplor_fmt.md).
...
- css:
  ...
  [`tab_css`](https://bricenocenti.github.io/tabxplor/fr/reference/tab_css.md)'s
  ...
  like
  [`tab_kable()`](https://bricenocenti.github.io/tabxplor/fr/reference/tab_html.md)'s
