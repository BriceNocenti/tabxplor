...
Extract a column of a tabxplor tab (with the Phase 10i-B add_n/add_pct
back-compat shim)
...
The column, or the reconstructed add_n/add_pct column (deprecated), or
the base method's value.
