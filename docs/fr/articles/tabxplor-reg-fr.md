...
[`tab()`](https://bricenocenti.github.io/tabxplor/fr/reference/tab.md) :
le même modèle est ajusté **au sein de chaque modalité** d’une variable
de regroupement, et les tableaux par groupe sont empilés en un seul
tableau groupé. Il répond à « cet effet tient-il dans chaque sous-groupe
