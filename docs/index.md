...
- **Regression tables too**:
  ...
  presents logistic and other models with the same visual language, next
  to the observed percentages.
...
console](reference/figures/README-hero.jpg)

A color-coded tabxplor cross-table in the console
