...
jmvtabOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public = list(
        initialize = function(
            ...
            exportExcel = NULL,
            doExportExcel = FALSE,
            xl_path = "D:/Documents/Excel_test.xlsx", ...) {
            ...
            private$..exportExcel <- jmvcore::OptionAction$new(
                "exportExcel",
                exportExcel)
            private$..doExportExcel <- jmvcore::OptionBool$new(
                "doExportExcel",
                doExportExcel,
                default=FALSE,
                hidden=TRUE)
            private$..xl_path <- jmvcore::OptionString$new(
                "xl_path",
                xl_path,
                default="D:/Documents/Excel_test.xlsx")
            ...
            self$.addOption(private$..doExportExcel)
    ...
    active = list(
        ...
        doExportExcel = function() private$..doExportExcel$value,
...
#' @param doExportExcel Trigger for Excel export
#' @param xl_path Path of the Excel file to create.
