...
| pct  | `contrib` | χ² contribution | idem, grey if \|residual\| < z(95%) | **the residual itself**, `residual` breaks |
...
`residual` break scale, whose default `c(1.96, 2.58, 3.89, 6)` is written
...
attribute. Every significance threshold inside them (the greying, and the `residual` anchor) therefore
