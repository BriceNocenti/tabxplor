...
## Sub-tables, and the most compact table
...
Put a battery together with `spread_vars` (above) and you get the most condensed table the package draws — six items, two sexes, one screen:
...
- `vignette("tabxplor-all-else-equal")` — regressions, taught the way this vignette teaches cross-tables: one analysis walked from a first table to a finished sentence.
