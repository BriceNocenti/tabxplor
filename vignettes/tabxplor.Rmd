...
- computed the way every interval in tabxplor is: weighted estimate, and a base that follows the
  inference basis — the raw *n*, or the whole table's effective *n* under
  `options(tabxplor.design_effect = TRUE)` or under a `survey` design. One base per table, so a counts
