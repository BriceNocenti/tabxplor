...
# Force 256-colour ANSI so the console tables render coloured when knitted (tabxplor builds its
# terminal styles with cli, which reads options("cli.num_colors")). Set BEFORE the palette is
# (re)built below; fansi::sgr_to_html() then turns the ANSI into the HTML shown in this vignette.
