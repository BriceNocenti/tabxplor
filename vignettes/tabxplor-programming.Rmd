...
- **Valid fields** are `pct`, `n`, `wn`, `mean`, `est`, `base`, `diff`, `ratio`, `ci`, `or`, `ctr`, `var`, `resid`, `obs`, `gap` — the same set as the single-field displays.
...
- Common layouts have **names**: `"est"`, `"est_ci"`, `"est_base"`, `"base_est"`, `"base"`, `"base_ci"`. They are the same names in `tab()`, in `tab_reg()` and in `set_display()`.
