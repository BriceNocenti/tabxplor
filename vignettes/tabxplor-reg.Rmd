...
`or_plot()` draws a forest plot of the odds ratios of a finished table. `reg_check_plots()` draws the model checks — the same five nouns as the footer rows, one panel each, faceted across every model in the table:
