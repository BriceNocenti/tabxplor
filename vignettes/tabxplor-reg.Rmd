...
Note the difference: `display = "est_base"` *keeps* the odds-ratio column and adds the adjusted probability beside it, whereas `effect = "marginal"` (seen above) turns the **whole** column into a marginal effect.
