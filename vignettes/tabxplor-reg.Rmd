...
Without a design, `options(tabxplor.kish_neff = TRUE)` widens the observed columns' intervals using Kish's effective sample size — a correction for unequal weighting only (see `vignette("tabxplor")` for the full three-rung ladder). The model columns are design-based either way.
