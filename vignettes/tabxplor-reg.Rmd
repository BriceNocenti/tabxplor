...
The first group is the baseline and stays uncoloured (nothing is compared to itself); reorder the
levels with `forcats::fct_relevel()` to pick another one. Unlike the model-versus-observed case, the
groups here are separate people, so a real test of these differences is straightforward — it is on the
roadmap.
