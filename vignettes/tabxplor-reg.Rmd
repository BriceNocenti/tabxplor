...
Every cell below is the acronym the combination puts in the column header, after the constant `Model_` prefix (`diff` is `Model_diff`, `mRR` is `Model_mRR`). The first column says which outcomes reach each row, and † marks the family's default measure.

| outcome kind      | `family`          | `measure`        | `"coefficient"` | `"marginal"` | `"at_reference"` |
|-------------------|-------------------|------------------|-----------------|--------------|------------------|
| numeric           | gaussian          | `"difference"` † | `diff`          | `mdiff`      | `refdiff`        |
| numeric           | gaussian          | `"ratio"`        | `RoM`           | `mRoM`       | `refRoM`         |
| numeric           | gaussian          | `"odds_ratio"`   | not defined     | —            | —                |
| numeric (count)   | poisson           | `"ratio"` †      | `IRR`           | `mIRR`       | `refIRR`         |
