...
│                              jmvtab_reg_dep_family/_dep_modelled_first/_dep_trials; jmvtab_reg_build now
│                              GROUPS outcomes by resolved family (1 group -> one shared table; several ->
│                              a tabxplor_tabs list -- the interim before Phase 15e's per-column family)
