...
**Should numeric predictors be CENTERED by default? This is the first draft of the research to be pushed forwards.** The four questions asked — good default? sound for counts as well as continuous? global option or vectorised argument? numeric outcomes? — answered from the code, a measurement and the literature.
