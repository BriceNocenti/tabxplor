...
├── jmvtabreg-cache.R (~230 L) Phase 15b: the jmvtabreg (Regressions) live-UI fit cache +
...
└── jmvtabreg.h.R            Jamovi Regressions UI header (auto-generated by prepare(), NOT yet created)
```
...
##### Phase 15b-ii : the model-comparison "+" builder
